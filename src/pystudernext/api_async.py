...
class AsyncNextApi:
    ...
    def remote_host(self) -> str|None:
        """Returns the IP address of the Next Gateway we connect to, otherwise None"""
    ...
    async def _get_client(self):
        ...
        if not self.connected:
            self._client = AsyncModbusTcpClient(self._host, self._port, timeout=CONNECT_TIMEOUT)
