...
def main():
    ...
    api = NextApi("192.168.1.123", DEFAULT_PORT)    # host and port number of the Next Gateway
    try:
        if not api.start():
        ...
        value = api.request_value(param_6900, "NX3_1")  # Next3 slave range is 14 to 28, or use "NX3_1" to "NX3_15"
